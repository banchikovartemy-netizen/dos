...
#include "keyboard.h"
typedef enum {
    APP_FILES=0,APP_TERMINAL,APP_NOTES,APP_PLAYER,APP_PHOTOS,APP_VIDEO,
    APP_CALCULATOR,APP_GAMES,APP_BROWSER,APP_ANIMATIONS,APP_MAP,
    APP_GUIDE,APP_FETCHCFG,APP_NETWORK,APP_SYSTEM,APP_SETTINGS,APP_COUNT
} AppId;
